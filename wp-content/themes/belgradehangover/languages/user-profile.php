...
$getParams['limit'] = 100;
$transactions = $ledgerService->get($getParams)->wait()['data']['transactions'];
			...
			<div class="container">
				<div class="row balance-box">
					...
					<div class="offset-md-3 col-md-3 text-center" style="border-left: 1px dashed black;">
						...
						<span class="user-balance text-center"><?php echo round($userBalance, 2); ?><img src="/belgradehangover/wp-content/themes/belgradehangover/img/belgrade-hangover-coin.svg" style="width: 3rem; display: inline-block; margin-left: 0.8rem; margin-bottom: 0.5rem" alt=""></span>
							...
							if (!empty($transactions)) {
								...
								echo "<li class='list-group-item row'>
										...
										<div class='col-md-3'><p class='center change' style='color:$color'>"
											. $plusOrMinus . round($amount, 2). "<img src='/belgradehangover/wp-content/themes/belgradehangover/img/belgrade-hangover-coin.svg' style='width: 2rem; display: inline-block; margin-left: 1rem;'' alt=''>
										</p></div>
				...
				<div class="col-md-5">
					...
					if ( in_array( 'photographers', (array) $user->roles ) ) {
						...
						echo '<p class="balance-amount-circle">' . round($amountEarned, 2) . "<img src='/belgradehangover/wp-content/themes/belgradehangover/img/belgrade-hangover-coin.svg' style='width: 1.5rem; display: inline-block; margin-left: 0.2rem; margin-bottom: 0.5rem' alt=''>" . '</p></div>';
					} else {
